...
exports.encode = exports.deleteMetainfo = exports.saveMetainfo = exports.validateInput = exports.progressBar = exports.splitJsonArray = exports.readCSV = exports.handleReadError = exports.showGraphQLErrors = exports.sleep = exports.RETRY_INTERVAL_S = exports.MAX_RETRIES = exports.METAINFO_FILE = exports.MAX_ENTRIES_PER_REQUEST = exports.DELIMITER = void 0;
...
exports.showGraphQLErrors = (e) => {
    if (e.graphQLErrors) {
        vtex_1.logger.error(ramda_1.join('\n', ramda_1.pluck('message', e.graphQLErrors)));
        return true;
    }
};
exports.handleReadError = (path) => (error) => {
    console.log(JSON.stringify(error));
    vtex_1.logger.error(`Error reading file: ${path}`);
    vtex_1.logger.error(`${error.message}`);
    process.exit();
};
const normalizePath = (path) => {
    try {
        ...
        vtex_1.logger.error(`Error in URI: ${path}`);
        throw err;
    }
};
...
exports.validateInput = (schema, routes) => {
    ...
    vtex_1.logger.error('Errors validating input:');
