...
const Rewriter_1 = require("../../clients/apps/Rewriter");
...
const handleExport = async (csvPath) => {
    const indexHash = crypto_1.createHash('md5').update(`${account}_${workspace}_${csvPath}`).digest('hex');
...
exports.default = async (csvPath) => {
    try {
        ...
        vtex_1.logger.error('Error handling export\n');
        ...
        vtex_1.logger.error(`Retrying in ${utils_1.RETRY_INTERVAL_S} seconds...`);
        vtex_1.logger.info('Press CTRL+C to abort');
