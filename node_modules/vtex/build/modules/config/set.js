    ...
    switch (name) {
        case 'env':
            if (!ramda_1.contains(value, envValues)) {
                throw utils_1.createFlowIssueError(`Invalid value for environment "${value}". Possible values are: ${envValues.join(', ')}`);
            }
        ...
        case 'cluster':
            ...
            break;
        default:
            throw utils_1.createFlowIssueError(`The supported configurations are: ${chalk_1.default.blue('env')}, ${chalk_1.default.blue('cluster')}`);
    }
};
